...
>
  ...
  {airportDropdown && (
    <ul className="dropdown-menu">
      <li><NavLink to="/bristol" className={({ isActive }) => isActive ? "active" : ""}>Bristol Airport</NavLink></li>
      <li><NavLink to="/gatwick" className={({ isActive }) => isActive ? "active" : ""}>Gatwick Airport</NavLink></li>
      <li><NavLink to="/heathrow" className={({ isActive }) => isActive ? "active" : ""}>Heathrow Airport</NavLink></li>
      <li><NavLink to="/luton" className={({ isActive }) => isActive ? "active" : ""}>Luton Airport</NavLink></li>
      <li><NavLink to="/manchester" className={({ isActive }) => isActive ? "active" : ""}>Manchester Airport</NavLink></li>
      <li><NavLink to="/stansted" className={({ isActive }) => isActive ? "active" : ""}>Stansted Airport</NavLink></li>
    </ul>
  )}
</li>
